...
export class LightWorldMap {
  static setup (l:string[], config:Config):DungeonData {
    ...
    entry.nodes.push(new DungeonNode(
      ...
      DungeonNode.noReqs, 'lw-linkshouse', 'house'));
    entry.nodes.push(new DungeonNode(
      'Sanctuary', 50, 51, DungeonNodeStatus.SQ_OPTION,
      DungeonNode.noReqs, 'hc-sanctuary', 'sanct'));
    entry.nodes.push(new DungeonNode(
    ...
    }, 'lw-octorok-field', 'right'));
    m.nodes.push(new DungeonNode(
      '', 72, 71, DungeonNodeStatus.OPEN_DOOR,
    function(items:Items, config:Config) {
      return items.gameState === 4; 
    }, 'lw-south-house-portal', 'down'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-flute4', 'up-right'));
    m.nodes.push(new DungeonNode(
      '', 95, 71, DungeonNodeStatus.OPEN_DOOR,
    function(items:Items, config:Config) {
        return items.glove;
    }, 'lw-south-house-portal', 'right'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-grove', 'up'));
    m.nodes.push(new DungeonNode(
      '', 10, 21, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-race-game', 'up-left'));
    m.nodes.push(new DungeonNode(
      '', 8, 56, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-south-grove-cave', 'left', [1]));
    lwData.dungeonMaps.push(m);
    ...
    DungeonNode.noReqs, 'hc-left', 'up-left', [1]));
    m.nodes.push(new DungeonNode(
      'Dark World Portal', 50, 61, DungeonNodeStatus.PORTAL,
    function(items:Items, config:Config) {
    ...
    DungeonNode.noReqs, 'lw-octorok-field', 'down'));
    m.nodes.push(new DungeonNode(
      '', 30, 38, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-graveyard', 'left'));
    m.nodes.push(new DungeonNode(
      '', 70, 38, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-flute2', 'right'));
    m.nodes.push(new DungeonNode(
      '', 52, 14, DungeonNodeStatus.WATER_WARP,
    function(items:Items, config:Config) {
        return items.flippers;
    }, 'lw-south-house-portal', 'warp', [-1], 0, 
    DungeonNode.noReqs));
    lwData.dungeonMaps.push(m);
    ...
    DungeonNode.noReqs, 'lw-octorok-field', 'up'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-desert', 'left'));
    m.nodes.push(new DungeonNode(
      '', 90, 50, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-dam', 'dam'));
    m.nodes.push(new DungeonNode(
      '', 81, 34, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-south-house-portal', 'up'));
    m.nodes.push(new DungeonNode(
      '', 93, 60, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-minimoldorm-entrance', 'right'));
    m.nodes.push(new DungeonNode(
    ...
    m.nodes.push(new DungeonNode(
      ...
      DungeonNode.noReqs, 'lw-south-grove', 'down'));
    m.nodes.push(new DungeonNode(
    ...
    }, 'lw-hyrule-castle', 'down', [-1], 2));
    m.nodes.push(new DungeonNode(
      'Link\'s Uncle', 50, 22, DungeonNodeStatus.CLOSED_CHEST,
    DungeonNode.noReqs, l[1], 'c1'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-sanctuary-entrance', 'left'));
    m.nodes.push(new DungeonNode(
      '', 94, 78, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-east-sanctuary', 'right'));
    m.nodes.push(new DungeonNode(
      '', 15.5, 34.5, DungeonNodeStatus.HOLE,
    function(items:Items, config:Config) {
        return items.glove;
    }, 'hc-bombablewall', 'sewers'));
    m.nodes.push(new DungeonNode(
      '', 56, 20, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-gy-ledge', 'up', [1]));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-east-sanctuary', 'left'));
    m.nodes.push(new DungeonNode(
      '', 94, 32, DungeonNodeStatus.OPEN_DOOR,
    function(items:Items, config:Config) {
        return items.glove;
    }, 'lw-zora-entrance', 'right'));
    m.nodes.push(new DungeonNode(
      '', 40, 67, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-potion-shop', 'shop'));
    lwData.dungeonMaps.push(m);

    m = new DungeonMapData('lw-flute5', 'Eastern Portal');
    m.nodes.push(new DungeonNode(
      '', 75, 5, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-eastern-palace', 'up'));
    m.nodes.push(new DungeonNode(
      'Dark World Portal', 80, 73, DungeonNodeStatus.PORTAL,
    function(items:Items, config:Config) {
        return items.hammer && items.glove;
    }, '', 'portal'));
    lwData.dungeonMaps.push(m);
    ...
    DungeonNode.noReqs, 'lw-lostwoods', 'up-left'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-fortune-teller', 'up-right'));
    m.nodes.push(new DungeonNode(
      '', 94, 81, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-blacksmiths-entrance', 'right'));
    m.nodes.push(new DungeonNode(
      '', 87, 96, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-race-game', 'down'));
    m.nodes.push(new DungeonNode(
      '', 10, 20, DungeonNodeStatus.HOLE,
    DungeonNode.noReqs, 'lw-well', 'well'));
    m.nodes.push(new DungeonNode(
      '', 51.5, 18, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-blindshut', 'blind'));
    m.nodes.push(new DungeonNode(
      '', 39, 66, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-chicken', 'chicken'));
    m.nodes.push(new DungeonNode(
      '', 64, 77, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-bar', 'bar'));
    m.nodes.push(new DungeonNode(
      '', 62.5, 64, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-sickkid', 'sickkid'));
    m.nodes.push(new DungeonNode(
      'Bottle Vendor', 38, 34, DungeonNodeStatus.CLOSED_CHEST,
    DungeonNode.noReqs, l[28], 'c'));
    m.nodes.push(new DungeonNode(
    ...
    m.nodes.push(new DungeonNode(
      'Dark World Portal', 73, 70, DungeonNodeStatus.PORTAL,
    function(items:Items, config:Config) {
      return items.glove;
    }, '', 'portal'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-kakariko', 'down-left'));
    m.nodes.push(new DungeonNode(
      '', 38, 94, DungeonNodeStatus.OPEN_DOOR,
    function(items:Items, config:Config) {
        return items.hammer;
    }, 'lw-kak-portal', 'down', [-1], 1));
    m.nodes.push(new DungeonNode(
      '', 88, 94, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-fortune-teller', 'down-right'));
    m.nodes.push(new DungeonNode(
      '', 92, 14, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-lumberjack', 'right'));
    m.nodes.push(new DungeonNode(
      '', 16, 20, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-pedestal', 'up'));
    m.nodes.push(new DungeonNode(
      '', 75, 52, DungeonNodeStatus.HOLE,
    DungeonNode.noReqs, 'lw-thief-hideout', 'hole'));
    m.nodes.push(new DungeonNode(
      'Mushroom Item', 47, 34, DungeonNodeStatus.VIEWABLE_CLOSED_CHEST,
    DungeonNode.noReqs, l[42], 'c'));
    lwData.dungeonMaps.push(m);

    m = new DungeonMapData('lw-lumberjack-item', 'Lumberjack Cave', true);
    m.nodes.push(new DungeonNode(
      '', 75, 93, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-lumberjack', 'down'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-spectacle-rock', 'up'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-flute1', 'down'));
    m.nodes.push(new DungeonNode(
      '', 78, 50, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-flute1', 'down'));
    m.nodes.push(new DungeonNode(
      '', 45, 41, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-spectacle-cave', 'cave'));
    m.nodes.push(new DungeonNode(
      '', 45, 58, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-spectacle-cave', 'drop', [-1], 1));
    m.nodes.push(new DungeonNode(
      'Dark World Portal', 75, 36, DungeonNodeStatus.PORTAL,
    DungeonNode.noReqs, '', 'portal'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-hera', 'up', [1]));
    lwData.dungeonMaps.push(m);
    ...
    }, 'lw-spectacle-rock', 'down', [-1], 0,
    DungeonNode.noReqs));
    m.nodes.push(new DungeonNode(
      '', 28, 53, DungeonNodeStatus.HOLE,
    DungeonNode.noReqs, 'lw-flute1', 'hole'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'toh-entry', 'hera'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-spectacle-rock', 'down'));
    m.nodes.push(new DungeonNode(
    ...
    DungeonNode.noReqs, 'lw-spiral', 'spiral'));
    m.nodes.push(new DungeonNode(
      '', 43, 70, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-east', 'down'));
    m.nodes.push(new DungeonNode(
      '', 43, 50, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-paradox5', 'cave'));
    m.nodes.push(new DungeonNode(
      'Dark World Portal', 76, 48, DungeonNodeStatus.PORTAL,
    function(items:Items, config:Config) {
    ...
    DungeonNode.noReqs, 'lw-paradox2', 'topcave', [-1], 1));
    m.nodes.push(new DungeonNode(
      '', 93, 65, DungeonNodeStatus.OPEN_DOOR,
    DungeonNode.noReqs, 'lw-paradox5', 'bottomcave'));
    m.nodes.push(new DungeonNode(
      'Dark World Portal', 44, 71, DungeonNodeStatus.PORTAL,
    function(items:Items, config:Config) {
      return items.glove === 2;
    }, '', 'portal'));
    lwData.dungeonMaps.push(m);
